...
timevis(
  data.frame(id=c(1:7),
           content =c("Shushilan", "Action Contre la Faim","BRAC","Danish Refugee Council","Trinity College Dublin",
                      "Danish Refugee Council","international Development Enterprises"),
           start=c("2019-10-03","2020-02-27","2020-12-20","2021-05-25","2022-03-01","2023-08-27","2024-02-01"),
           end=c("2020-02-26","2020-11-30","2021-04-25","2022-02-20","2023-03-31","2029-02-20",NA),
           style = c("color: #008000;", "color: red;","color: red;","color: red;","color: red;","color: red;","color: red;"),
           title = "Timeline of Tasbiul"),
  options = list(
